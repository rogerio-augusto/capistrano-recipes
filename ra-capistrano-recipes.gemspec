...
Gem::Specification.new do |s|
  s.name = %q{ra-capistrano-recipes}
  s.version = "0.7.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Phil Misiowiec", "Leonardo Bighetti", "Rog\303\251rio Augusto"]
  s.date = %q{2011-02-10}
  s.description = %q{Extend the Capistrano gem with these useful recipes}
  s.email = %q{rogerio@depoiseuleio.com}
  s.extra_rdoc_files = [
    "LICENSE",
    "README.rdoc"
  ]
  ...
  s.homepage = %q{http://github.com/rogerio-augusto/capistrano-recipes}
  s.require_paths = ["lib"]
